...
% Xeval : les donnees dont on veut predire la classe. Xeval est une matrice
% de dimensions Ne x d (d: nombre de variables)

% Xapp : donnees d'apprentissage (donnees de reference), matrice Na x d
...
% faut faire l'appel comme [YPeval,MatDist]=knn(Xeval, Xapp, Yapp, k, [])

% YPeval : vecteur (taille Ne) des labels prodits pour les points de Xeval



% on determine combien de classes on a dans les donnees
